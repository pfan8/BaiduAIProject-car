...
# 2. pad oov处理后的数据
train_x_update_vocab_path = os.path.join(root, 'data', 'train_X_update_vocab_data.csv')
train_y_update_vocab_path = os.path.join(root, 'data', 'train_Y_update_vocab_data.csv')
...
# 词向量路径
save_wv_model_path = os.path.join(root, 'output', 'word2vec', 'word2vec.model')
# 词向量矩阵保存路径
embedding_matrix_path = os.path.join(root, 'output', 'word2vec', 'embedding_matrix')
# 字典路径
word2id_path = os.path.join(root, 'output', 'word2vec', 'word2id')
id2word_path = os.path.join(root, 'output', 'word2vec', 'id2word')
